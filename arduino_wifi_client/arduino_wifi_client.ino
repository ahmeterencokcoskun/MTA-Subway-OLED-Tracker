...
const unsigned long ALERT_PREVIEW_MS = 2500;
...
bool fetch_json_and_render() {
  ...
  extractJsonInt(jsonBody, "alert_flag", &tmpAlertFlag);
  ...
  renderMainScreen();
  if (alertFlag == 1 && strlen(alertMsg) > 0 && strcmp(alertMsg, "No details available") != 0) {
    delay(250);
    renderAlertScreen();
